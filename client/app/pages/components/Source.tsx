...
const Source = ({children, title, link, img, delay = 0}: SourceProps) => {
  return (
    <Fade className="self-stretch text-white flex flex-col gap-4 bg-slate-900 p-6 cursor-pointer rounded-lg duration-300 box-border flex-1 text-left aspect-[13/16] border-[1px] border-solid border-slate-700 hover:bg-slate-800 hover:border-slate-600" delay={delay}>
